...
{
    [Parse setApplicationId:@"uoNesTBDTLr2fJwEMwQatMkbny60EqmAWgdXN20g"
                  clientKey:@"7JpFXSjvJDf6IBjeeKB3VwnThaxo9saT5MqKQNWA"];
...
//    return YES;
    ...
    self.tabBarController = (UITabBarController *)[sb instantiateViewControllerWithIdentifier:@"appTabBar"];
    self.loginViewController = (UIViewController *)[sb instantiateViewControllerWithIdentifier:@"loginViewController"];
